...
try:
    ...
    st.error("The data file (innovategear_sales_data.csv) was not found. Please make sure it's in the same directory as the script.")
    st.stop()
...
# --- CHARTS ---
col_left, col_right = st.columns((7, 5)) # Create two columns for charts
...
# Display filtered data in a clean, interactive table
st.dataframe(
    filtered_df,
